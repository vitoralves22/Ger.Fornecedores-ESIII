...
public class EmpresaDAO extends AbstractJdbcDAO{
    ...
    public void salvar(EntidadeDominio entidade) throws SQLException {
		...
		PreparedStatement pst=null;
            ...
            pst.setInt(3, empresa.getForId());
            pst.setTimestamp(4, new Timestamp(empresa.getDtCadastro().getTime()));
            pst.executeUpdate();
    ...
    public void alterar(EntidadeDominio entidade) throws SQLException {
		...
		PreparedStatement pst=null;
            ...
            sql.append("UPDATE tab_empresas SET emp_tipo=?, emp_tipo_fornecimento=?"); 
            sql.append("WHERE emp_for_id=?");
